(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('jalali-moment'), require('persian-digit-tools')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'jalali-moment', 'persian-digit-tools'], factory) :
	(factory((global['ng2-jalali-date-picker-full-farsi'] = {}),global.ng.core,global.ng.forms,global.ng.common,global['jalali-moment'],global['persian-digit-tools']));
}(this, (function (exports,core,forms,common,momentNs,persianDigitTools) { 'use strict';
...
var DatePickerComponent = (function () {
    ...
    Object.defineProperty(DatePickerComponent.prototype, "selected", {
        ...
        set: function (selected) {
            ...
            this.inputElementValue = persianDigitTools.DigitConvertor.toPersian(((this.utilsService
...
var DayCalendarComponent = (function () {
    ...
    Object.defineProperty(DayCalendarComponent.prototype, "currentDateView", {
        ...
        set: function (current) {
            ...
            this.navLabel = persianDigitTools.DigitConvertor.toPersian(this.dayCalendarService.getHeaderLabel(this.componentConfig, this._currentDateView));
    ...
    DayCalendarComponent.prototype.getDayBtnText = function (day) {
        return persianDigitTools.DigitConvertor.toPersian(this.dayCalendarService.getDayBtnText(this.componentConfig, day.date));
    };
    /**
     * @param {?} day
     * @return {?}
...
var MonthCalendarComponent = (function () {
    ...
    Object.defineProperty(MonthCalendarComponent.prototype, "currentDateView", {
        ...
        set: function (current) {
            ...
            this.navLabel = persianDigitTools.DigitConvertor.toPersian(this.monthCalendarService.getHeaderLabel(this.componentConfig, this.currentDateView));
...
var TimeSelectComponent = (function () {
    ...
    TimeSelectComponent.prototype.calculateTimeParts = function (time) {
        this.hours = persianDigitTools.DigitConvertor.toPersian(this.timeSelectService.getHours(this.componentConfig, time));
        this.minutes = persianDigitTools.DigitConvertor.toPersian(this.timeSelectService.getMinutes(this.componentConfig, time));
        this.seconds = persianDigitTools.DigitConvertor.toPersian(this.timeSelectService.getSeconds(this.componentConfig, time));
...
//# sourceMappingURL=ng2-jalali-date-picker-full-farsi.umd.js.map
